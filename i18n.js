  ...
  "es": {
    "home": {
      ...
      "hero": {
        ...
        "sub": "<ul class=\"hero-checkpoints\"><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">Circuito propuesto de <strong>8 etapas</strong> que aprovecha tramos del GR‑174 y otros senderos señalizados.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">Enlazados mediante caminos rurales y pistas forestales entre los <strong>19 pueblos</strong> del Priorat, con <strong>Falset</strong> como puerta de entrada y salida.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">No es un itinerario propio homologado ni señalizado de forma continua.</span></li></ul>",
        "quick1": "19 pueblos",
        "quick2": "Eje GR‑174",
      ...
      "terrain": {
        ...
        "i3": "Muy poca infraestructura turística <strong>fuera de fin de semana</strong>",
        "iSenal": "<strong>Señalización discontinua</strong>: no es un itinerario propio homologado",
        "iGpx": "<strong>Imprescindible</strong> llevar track GPX offline",
    ...
    "inscripcion": {
      ...
      "form": {
        ...
        "validationErr": "⚠ Rellena todos los campos obligatorios para poder inscribirte.",
    ...
    "finalizados": {
      ...
      "statsPremium": {
        "eyebrow": "Datos del proyecto",
        "h2": "El Camí del Prior en cifras",
        "p": "Un vistazo real a quién completa la ruta, de dónde viene y qué variante elige — calculado a partir de las inscripciones verificadas y no verificadas.",
        "completionLabel": "de los inscritos han completado y verificado su paso",
        "completionSub": "{verified} de {total} inscritos",
        "splitH": "Circuito completo vs. ruta corta",
        "variantLong": "Circuito completo (8 etapas)",
        "variantShort": "Ruta corta (3 días)",
        "insight1": "La ruta corta tiene una tasa de finalización del {pctShort}%, frente al {pctLong}% del circuito completo.",
        "insight1NoData": "Todavía no hay suficientes datos para comparar la tasa de finalización entre variantes.",
        "insight2": "El origen más frecuente es {origin}, con {count} caminantes ({pct}%).",
        "insight2NoData": "Todavía no se ha registrado ningún origen.",
        "insight3": "Los inscritos proceden de {n} lugares distintos.",
        "originsH": "¿De dónde vienen?",
        "originsOthers": "Otros",
  ...
  "ca": {
    "home": {
      ...
      "hero": {
        ...
        "sub": "<ul class=\"hero-checkpoints\"><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">Circuit proposat de <strong>8 etapes</strong> que aprofita trams del GR‑174 i altres senders senyalitzats.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">Enllaçats mitjançant camins rurals i pistes forestals entre els <strong>19 pobles</strong> del Priorat, amb <strong>Falset</strong> com a porta d'entrada i sortida.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">No és un itinerari propi homologat ni senyalitzat de manera contínua.</span></li></ul>",
        "quick1": "19 pobles",
        "quick2": "Eix GR‑174",
      ...
      "terrain": {
        ...
        "i3": "Molt poca infraestructura turística <strong>fora de cap de setmana</strong>",
        "iSenal": "<strong>Senyalització discontínua</strong>: no és un itinerari propi homologat",
        "iGpx": "<strong>Imprescindible</strong> portar track GPX offline",
    ...
    "inscripcion": {
      ...
      "form": {
        ...
        "validationErr": "⚠ Omple tots els camps obligatoris per poder inscriure't.",
    ...
    "finalizados": {
      ...
      "statsPremium": {
        "eyebrow": "Dades del projecte",
        "h2": "El Camí del Prior en xifres",
        "p": "Una mirada real a qui completa la ruta, d'on ve i quina variant tria — calculat a partir de les inscripcions verificades i no verificades.",
        "completionLabel": "dels inscrits han completat i verificat el seu pas",
        "completionSub": "{verified} de {total} inscrits",
        "splitH": "Circuit complet vs. ruta curta",
        "variantLong": "Circuit complet (8 etapes)",
        "variantShort": "Ruta curta (3 dies)",
        "insight1": "La ruta curta té una taxa de finalització del {pctShort}%, davant del {pctLong}% del circuit complet.",
        "insight1NoData": "Encara no hi ha prou dades per comparar la taxa de finalització entre variants.",
        "insight2": "L'origen més freqüent és {origin}, amb {count} caminants ({pct}%).",
        "insight2NoData": "Encara no s'ha registrat cap origen.",
        "insight3": "Els inscrits procedeixen de {n} llocs diferents.",
        "originsH": "D'on vénen?",
  ...
  "en": {
    "home": {
      ...
      "hero": {
        ...
        "sub": "<ul class=\"hero-checkpoints\"><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">A proposed <strong>8-stage circuit</strong> that uses stretches of the GR‑174 and other waymarked trails.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">Linked by rural paths and forest tracks between Priorat's <strong>19 villages</strong>, with <strong>Falset</strong> as the entry and exit point.</span></li><li><span class=\"hero-checkpoint-icon\" aria-hidden=\"true\">i</span><span class=\"ck-text\">It is not its own approved route, nor is it waymarked continuously.</span></li></ul>",
        "quick1": "19 villages",
        "quick2": "GR‑174 axis",
      ...
      "terrain": {
        ...
        "i1": "<strong>166.4 km over 8 stages</strong> (or 53.6 km over 3 stages) — a demanding route with llicorella slate and steep gradients",
        "iSeason": "<strong>Best season: April–June and September–November.</strong> Avoid July and August (35–38&nbsp;°C)",
        "iAgua": "<strong>Water: 2.5–3&nbsp;L per stage; 4–5&nbsp;L on stages 2 and 5</strong>",
        "i2": "Little shade, intense heat in summer",
        "i3": "Very little tourist infrastructure <strong>outside weekends</strong>",
        "iSenal": "<strong>Discontinuous waymarking</strong>: not an officially approved route of its own",
        "iGpx": "<strong>Essential</strong>: bring an offline GPX track",
    ...
    "inscripcion": {
      ...
      "form": {
        ...
        "validationErr": "⚠ Please fill in all required fields to sign up.",
    ...
    "finalizados": {
      ...
      "statsPremium": {
        ...
        "h2": "El Camí del Prior by the numbers",
        "p": "A real look at who completes the route, where they come from, and which variant they choose — calculated from verified and unverified sign-ups.",
        "completionLabel": "of sign-ups have completed and verified their crossing",
        "completionSub": "{verified} of {total} sign-ups",
        "splitH": "Full circuit vs. short route",
        "variantLong": "Full circuit (8 stages)",
        "variantShort": "Short route (3 days)",
        "insight1": "The short route has a {pctShort}% completion rate, versus {pctLong}% for the full circuit.",
        "insight1NoData": "Not enough data yet to compare completion rates between variants.",
        "insight2": "The most common origin is {origin}, with {count} walkers ({pct}%).",
        "insight2NoData": "No origin has been recorded yet.",
        "insight3": "Sign-ups come from {n} different places.",
        "originsH": "Where do they come from?",
        "originsOthers": "Other",
